                            																			...
                            																			for(pi[24] = input[25].values[0]; pi[24] <= input[25].values[1]; pi[24] += input[25].values[2])
                            																			{
                            																				for(pi[25] = input[26].values[0]; pi[25] <= input[26].values[1]; pi[25] += input[26].values[2])
                            																				{
                            																					for(pi[26] = input[27].values[0]; pi[26] <= input[27].values[1]; pi[26] += input[27].values[2])
                            																					{
                            																						...
                            																						{
                            																							for(pi[28] = input[29].values[0]; pi[28] <= input[29].values[1]; pi[28] += input[29].values[2])
                            																							{
                            																								for(pi[29] = input[30].values[0]; pi[29] <= input[30].values[1]; pi[29] += input[30].values[2])
                            																								{
                            																									for(pi[30] = input[31].values[0]; pi[30] <= input[31].values[1]; pi[30] += input[31].values[2])
                            																									{
                            																										for(pi[31] = input[32].values[0]; pi[31] <= input[32].values[1]; pi[31] += input[32].values[2])
                            																										{
                            																											for(pi[32] = input[33].values[0]; pi[32] <= input[33].values[1]; pi[32] += input[33].values[2])
                            																											{
                            																												for(pi[33] = input[34].values[0]; pi[33] <= input[34].values[1]; pi[33] += input[34].values[2])
                            																												{
                            																													for(pi[34] = input[35].values[0]; pi[34] <= input[35].values[1]; pi[34] += input[35].values[2])
                            																													{
																																					for(pi[35] = input[36].values[0]; pi[35] <= input[36].values[1]; pi[35] += input[36].values[2])
																																					{
																																						for(pi[36] = input[37].values[0]; pi[36] <= input[37].values[1]; pi[36] += input[37].values[2])
																																						{
																																							    sprintf(fname,"iFiles%d.txt",id);
																																								sprintf(foname,"oFiles%d.txt",id);
																																								outfiles = fopen(foname,"a");
																
																																								fprintf(outfiles,"%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf",ip_file[pf][0].value,ip_file[pf][1].value,pi[1],pi[2],pi[3],pi[4],pi[5],pi[6],pi[7],pi[8],pi[9],pi[10],pi[11],pi[12],pi[13],pi[14],pi[15],pi[16],pi[17],pi[18],pi[19],pi[20],pi[21],pi[22],pi[23],pi[24],pi[25],pi[26],pi[27],pi[28],pi[29],pi[30],pi[31],pi[32],pi[33],pi[34],pi[35],pi[36]);
																																								fclose(outfiles);
...
*****************************************************************************************************/
    ...
    fprintf(output,"%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,ERROR\n",input[0].name,input[1].name,input[2].name,input[3].name,input[4].name,input[5].name,input[6].name,input[7].name,input[8].name,input[9].name,input[10].name,input[11].name,input[12].name,input[13].name,input[14].name,input[15].name,input[16].name,input[17].name,input[18].name,input[19].name,input[20].name,input[21].name,input[22].name,input[23].name,input[24].name,input[25].name,input[26].name,input[27].name,input[28].name,input[29].name,input[30].name,input[31].name,input[32].name,input[33].name,input[34].name,input[35].name,input[36].name,input[37].name);
