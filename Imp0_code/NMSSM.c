...
{
    int i,j,prop_bool[prop_num],threads_obtained;
    char prop_name[64][prop_num];
...
*****************************************************************************************/                                                          
    ...
    {
        fscanf(input,"%s %d",&prop_name[i],&prop_bppl[i]);
    }*/
                            																						...
                            																						for(pi[27] = input[28].values[0]; pi[27] <= input[28].values[1]; pi[27] += input[28].values[2] )
                            																						{
                            																							for(pi[28] = input[29].values[0]; pi[28] <= input[29].values[1]; pi[28] += input[29].values[2] )
                            																							{
                            																								for(pi[29] = input[30].values[0]; pi[29] <= input[30].values[1]; pi[29] += input[30].values[2] )
                            																								{
                                																								...
                                																								fprintf(outfiles,"%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,%lf,"\
																																,ip_file[pf][0].value,ip_file[pf][1].value,pi[1],pi[2],pi[3],pi[4],pi[5],pi[6],pi[7],pi[8],pi[9],pi[10],pi[11],pi[12],\
																																pi[13],pi[14],pi[15],pi[16],pi[17],pi[18],pi[19],pi[20],pi[21],pi[22],pi[23],pi[24],pi[25],pi[26],pi[27],pi[28],pi[29]);
																							                                	...
																							                                	sprintf(s,"./main %s >> %s",fname,foname);
...
*****************************************************************************************************/
	...
	input[20].name,input[21].name,input[22].name,input[23].name,input[24].name,input[25].name,input[26].name,\
	input[27].name,input[28].name,input[29].name,input[30].name);
